...
class CoslamViewer : public QGLViewer
{
public:
	CoslamViewer();
	~CoslamViewer();
	...
	void addFrameMsg2(lsd_slam_viewer::keyframeMsgConstPtr msg);
	
	void addGraphMsg(lsd_slam_viewer::keyframeGraphMsgConstPtr msg);
	void addGraphMsg2(lsd_slam_viewer::keyframeGraphMsgConstPtr msg);
